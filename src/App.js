				...
				<Flex w={["100%", "28%"]} minHeight={["100vh", "95vh"]} direction="column">
					{
						...
						<Flex w="100%" h={["100vh", "95vh"]} px="5%" align="center" justify="center" color="#fff" bg="#2043b6">
							<Flex>
								<Text textAlign="center" fontSize={["40px", "30px"]}>
								...
								<Flex w="100%" justify="space-between">
									{
										sliderBar < 3 ?
										<>
											<Flex borderRadius="50px" w="45%" color="#2043b6" bg="#cdd7e9" fontWeight="bold" opacity="1" _hover={{ opacity: "0.9" }} transition="300ms ease-in-out" cursor="pointer" px="5" py={["5", "3"]} justify="center" fontSize="14px" onClick={() => {
												localStorage.setItem("isTerra", true)
												setScreen(3)
											}}>Skip</Flex>

											<Flex borderRadius="50px" w="45%" color="#fff" bg="#2043b6" fontWeight="bold" opacity="1" _hover={{ opacity: "0.9" }} transition="300ms ease-in-out" cursor="pointer" px="5" py={["5", "3"]} justify="center" fontSize="14px" onClick={() => {
												localStorage.setItem("isTerra", true)
												setScreen(3)
											}}><i className="mdi mdi-arrow-right" style={{ fontSize: "14px" }}></i></Flex>
										</>
										:
										<Flex borderRadius="50px" w="100%" color="#fff" bg="#2043b6" fontWeight="bold" opacity="1" _hover={{ opacity: "0.9" }} transition="300ms ease-in-out" cursor="pointer" px="5" py={["5", "3"]} justify="center" fontSize="14px" onClick={() => {
											localStorage.setItem("isTerra", true)
											setScreen(3)
										}}>Get started</Flex>
									}
						...
						<Flex w="100%" h={["100vh", "95vh"]} px="5%" align="center" justify="center" color="#fff" bg="#2043b6" direction="column">
							<Flex direction="column" pt="15%">
								<Text fontWeight="bold" fontSize={["22px", "20px"]} textAlign="center">Connect</Text>
							...
							<Flex w="100%" mt="auto" mb="3%" direction="column">
								<Flex borderRadius="50px" w="100%" color="#2043b6" bg="#fff" fontWeight="bold" opacity="1" _hover={{ opacity: "0.8" }} transition="300ms ease-in-out" cursor="pointer" px="5" py={["5", "3"]} justify="center" fontSize="14px" onClick={() => {
									setIsSend(false)
									setScreen(6)
								}}>New Wallet</Flex>
								...
								<Flex borderRadius="50px" w="100%" color="#2043b6" bg="#fff" fontWeight="bold" opacity="1" _hover={{ opacity: "0.8" }} transition="300ms ease-in-out" cursor="pointer" px="5" py={["5", "3"]} justify="center" fontSize="14px" onClick={() => setScreen(9)}>Access with Ledger</Flex>

								<Flex borderRadius="50px" w="100%" color="#fff" bg="rgba(255,255,255,0.1)" fontWeight="bold" opacity="1" _hover={{ opacity: "0.9" }} transition="300ms ease-in-out" cursor="pointer" px="5" py={["5", "3"]} justify="center" fontSize="14px" mt="2" onClick={() => {
									setIsSend(true)
									setScreen(4)
								}}>Recover Wallet</Flex>
							</Flex>
						...
						<Flex w="100%" minHeight={["100vh", "95vh"]} bg="#f2f4fd" direction="column">
							...
							<Flex flex="1" bg="#f2f4fd" py="4" direction="column" px="5%">
								...
								<textarea style={{ border: "1px solid #cdd7e9", height: "120px", borderRadius: "8px", padding: "1% 4%", background: "#fff", color: "#2043b6", fontSize: "12px" }} id="seedHolder" onInput={(e) => {
								...
								<Flex mt="auto" w="100%">
									<Flex borderRadius="50px" w="100%" color="#fff" bg={seedOk ? "#2043b6" : "#8b9cda"} opacity={seedOk ? "1" : "0.7" } fontWeight="bold" _hover={{ opacity: seedOk && "0.9" }} transition="300ms ease-in-out" cursor={seedOk ? "pointer" : "not-allowed" } px="5" py={["5", "3" ]}justify="center" fontSize="14px" mt="2" onClick={() => {
										if(seedOk) {
						...
						<Flex w="100%" minHeight={["100vh", "95vh"]} bg="#f2f4fd" direction="column">
							...
							<Flex flex="1" bg="#f2f4fd" py="4" direction="column" px="5%">
								...
								<input type="text" style={{ border: nError ? "1px solid #ff5762" : "1px solid #cdd7e9", borderRadius: "8px", padding: "3.5% 4%", background: "#fff", color: "#2043b6", fontSize: "12px" }} id="nameArea" placeholder="Enter 5-20 alphanumeric characters" onInput={(e) => {
								...
								<input type="password" style={{ border: pError ? "1px solid #ff5762" : "1px solid #cdd7e9", borderRadius: "8px", padding: "3.5% 4%", background: "#fff", color: "#2043b6", fontSize: "12px" }} id="passArea" placeholder="Must be at least 10 characters" onInput={(e) => {
								...
								<input type="password" style={{ border: cError ? "1px solid #ff5762" : "1px solid #cdd7e9", borderRadius: "8px", padding: "3.5% 4%", background: "#fff", color: "#2043b6", fontSize: "12px" }} id="conArea" placeholder="Confirm your password" onInput={(e) => {
								...
								<Flex mt="auto" w="100%">
									<Flex borderRadius="50px" w="100%" color="#fff" bg={passOk ? "#2043b6" : "#8b9cda"} opacity={passOk ? "1" : "0.7" } fontWeight="bold" _hover={{ opacity: passOk && "0.9" }} transition="300ms ease-in-out" cursor={passOk ? "pointer" : "not-allowed" } px="5" py={["5", "3"]} justify="center" fontSize="14px" mt="2" onClick={async () => {
										if(passOk) {
						...
						<Flex w="100%" minHeight={["100vh", "95vh"]} bg="#f2f4fd" direction="column">
							...
							<Flex px="5%" align="center" py="4" pb="15%" justify="center" flex="1" direction="column">
								...
								<Flex borderRadius="50px" w="100%" color="#fff" bg="#2043b6" opacity="1" fontWeight="bold" _hover={{ opacity: "0.9" }} transition="300ms ease-in-out" cursor="pointer" px="5" py={["5", "3"]} justify="center" fontSize="14px" mt="2" onClick={() => isSend ? setScreen(6) : setScreen(8)}>Try again</Flex>
							</Flex>
						</Flex>
						:
						screen === 8 ?
						<Flex w="100%" minHeight={["100vh", "95vh"]} bg="#f2f4fd" direction="column">
							<Flex color="#fff" bg="#2043b6" w="100%" py="3" px="5%" direction="column">
								<Flex w="100%" justify="space-between">
									<i className="mdi mdi-chevron-left" style={{ fontSize: "30px", marginLeft: "-10px", cursor: "pointer" }} onClick={() => setScreen(6)}></i>
									{
										progressNo(2)
									}
								</Flex>
							...
							<Flex flex="1" bg="#f2f4fd" py="4" direction="column" px="5%">
								...
								<Flex w="100%" mt="auto">
									<Flex borderRadius="50px" w="100%" color="#fff" bg="#2043b6" opacity="1" fontWeight="bold" _hover={{ opacity: "0.9" }} transition="300ms ease-in-out" cursor="pointer" px="5" py={["5", "3"]} justify="center" fontSize="14px" mt="2" onClick={() => {
										setLoading(true)
										setTimeout(function() {
											setLoading(false)
											setScreen(7)
